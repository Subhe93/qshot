...
<template>
  <div class="my-4 w-100">
    ...
    >
      <SwiperSlide v-for="item in props.items" :key="item.url">
        <NuxtLink
          ...
          :to="item.url"
        >
          <div class="overflow-hidden grid grid-cols-1 relative">
            <NuxtImg
              loading="lazy"
              width="96"
              v-blur-on-load
              :src="item.thumbnail_url"
              class="size-32 rounded-md border-gray-800/30 object-cover relative"
              alt="image youtube"
            />
